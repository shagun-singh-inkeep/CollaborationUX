...
- **`y-prosemirror`** ships remote-cursor and selection **decorations** out of the box — live human cursors (the [[guides/figma|Figma]] surface) are largely a *turn-it-on* once a reachable shared server exists.
