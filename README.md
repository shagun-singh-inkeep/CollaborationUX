...
- [[use-cases/internal-dogfooding|Internal dogfooding use cases — SPEC 1:1s & All Hands]] — two recurring internal meetings run on OK, as persona-by-persona user stories that stress-test the UX at 1:1 and All Hands scale.
